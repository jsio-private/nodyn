...
nodyn.exportEnums(module.exports, ClassHelpers.getClass("io.nodyn.zlib.Mode").values());
nodyn.exportEnums(module.exports, ClassHelpers.getClass("io.nodyn.zlib.Code").values());
nodyn.exportEnums(module.exports, ClassHelpers.getClass("io.nodyn.zlib.Level").values());
nodyn.exportEnums(module.exports, ClassHelpers.getClass("io.nodyn.zlib.Strategy").values());
nodyn.exportEnums(module.exports, ClassHelpers.getClass("io.nodyn.zlib.Flush").values());

function Zlib(mode) {
  if (!(this instanceof Zlib)) return new Zlib(mode);
  this._delegate = new (ClassHelpers.getClass("io.nodyn.zlib.NodeZlib"))(process._process, mode);
