...
var HTTPParser = ClassHelpers.getClass("io.nodyn.http.HTTPParser");
...
HTTPParser.REQUEST  = HTTPParser.REQUEST;
HTTPParser.RESPONSE = HTTPParser.RESPONSE;

HTTPParser.methods  = nodyn.arrayConverter(HTTPParser.METHODS);
